...
```json
{
  ...
  "targetElement": {
    "selector": { /* if triggered by element */ },
...
```json
{
  ...
  "targetElement": {
    "selector": { /* if focused on element */ }
  }
}
```
