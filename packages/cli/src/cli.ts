...
export async function cli() {
  ...
  program
    ...
    .option('--screenshot', 'Enable screenshot capture', false)
    .option('--screenshot-mode <mode>', 'Screenshot mode: on-failure, always, never', 'on-failure')
    .option('--screenshot-dir <path>', 'Directory to save screenshots', './screenshots')
